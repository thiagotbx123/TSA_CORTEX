...
class TestCalcPerf(unittest.TestCase):
    ...
    def test_none_status_no_eta_returns_no_eta(self):
        result = calc_perf(None, '', '')
        self.assertEqual(result, 'No ETA')
...
class TestCalcPerfWithHistory(unittest.TestCase):
    ...
    def test_in_progress_no_eta_returns_no_eta(self):
        r = self._rec(status='In Progress', originalEta='', finalEta='', eta='')
